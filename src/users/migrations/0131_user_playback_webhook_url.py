# Generated by Django 5.2.16 on 2026-09-05 20:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        AddFieldIfNotExists(
            model_name="user",
            name="playback_webhook_url",
            field=models.URLField(
                blank=True,
                default="",
                help_text="Outgoing webhook POSTed the live playback state whenever it changes. Blank disables it, which is the default.",
                max_length=500,
            ),
        ),
    ]
