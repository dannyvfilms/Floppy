# Generated by Django 5.2.16 on 2026-09-05 22:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        AddFieldIfNotExists(
            model_name="user",
            name="playback_webhook_secret",
            field=models.TextField(
                blank=True,
                default="",
                help_text="Encrypted shared secret for the playback webhook. When set, each request carries an X-Floppy-Signature header holding the HMAC-SHA256 of the exact body sent.",
            ),
        ),
    ]
